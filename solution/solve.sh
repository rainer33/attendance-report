...
mkdir -p /app/attendance/data

cd /app

cat > /app/attendance/report_generator.py <<'PYTHON'
...
def generate_monthly_report(
    ...
    # Rule #1 - Deduplicate attendance events
    unique_events = {}
    ...
    attendance = list(unique_events.values())

    # Filter to requested month (Rule #2)
    attendance = [
        event
        for event in attendance
    ...
    # Group attendance by employee and day
